...
/**
 * Utilitário responsável por gerar a imagem visual de um resíduo eletrônico.
 *
 * <p>
 * Esta classe cria um cartão digital em formato de imagem a partir dos dados de um
 * {@link ecowaste.model.ResiduoEletronico}. O cartão apresenta informações relevantes
 * do resíduo, como nome, categoria, peso, risco ambiental, valor estimado, localização,
 * destino e status.
 * </p>
 *
 * <p>
 * A geração da imagem é realizada com recursos nativos do Java, utilizando
 * {@link java.awt.image.BufferedImage}, {@link java.awt.Graphics2D},
 * {@link java.awt.Color} e {@link java.awt.Font}.
 * </p>
 *
 * <p>
 * Esta classe representa a primeira etapa do fluxo de processamento visual do
 * EcoWaste Framework. A imagem criada por ela é posteriormente convertida para
 * formatos como PPM, PGM e PBM, além de ser decomposta nos canais RGB.
 * </p>
 *
 * <p>
 * A existência desta classe conecta o projeto a fundamentos de visão computacional,
 * pois a imagem gerada passa a ser tratada como uma matriz de pixels que pode ser
 * processada, convertida e analisada pelo sistema.
 * </p>
 *
 * @author Lucas Miles
 */
